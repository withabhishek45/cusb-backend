...
const departments = [
  ...
  },
  {
    ...
    images: ["https://picsum.photos/seed/cs1/1200/600", "https://picsum.photos/seed/cs2/1200/600", "https://picsum.photos/seed/cs3/1200/600"],
    studentCount: 300,
    placementRate: 95,
    researchPapers: 200,
    fundedProjects: 25,
    researchGrants: 120,
    faculty: [
      { name: "Dr. Vikram Singh", designation: "Professor & Head", email: "vikram.cs@cusb.ac.in", phone: "+91-631-2223535", image: "https://picsum.photos/seed/faccs1/400/400", specialization: "Artificial Intelligence", qualification: "Ph.D. (IIT Madras), M.Tech Computer Science", experience: "22 years", publications: 90, researchInterests: "Machine Learning, Deep Learning, Computer Vision, NLP", awards: "IEEE Fellow 2020" },
      { name: "Dr. Sanjeev Kumar", designation: "Associate Professor", email: "sanjeev.cs@cusb.ac.in", phone: "+91-631-2223536", image: "https://picsum.photos/seed/faccs2/400/400", specialization: "Data Science", qualification: "Ph.D. (IIT Hyderabad), M.Tech Data Science", experience: "12 years", publications: 55, researchInterests: "Big Data Analytics, Data Mining", awards: "Best Teacher Award 2022" },
      { name: "Dr. Anjali Verma", designation: "Assistant Professor", email: "anjali.cs@cusb.ac.in", phone: "+91-631-2223537", image: "https://picsum.photos/seed/faccs3/400/400", specialization: "Cybersecurity", qualification: "Ph.D. (IIIT Delhi), M.Tech Information Security", experience: "8 years", publications: 32, researchInterests: "Network Security, Cryptography, Ethical Hacking", awards: "Cybersecurity Expert Award 2021" },
      { name: "Dr. Rahul Mishra", designation: "Assistant Professor", email: "rahul.cs@cusb.ac.in", phone: "+91-631-2223538", image: "https://picsum.photos/seed/faccs4/400/400", specialization: "Software Engineering", qualification: "Ph.D. (NIT Trichy), M.Tech Software Engineering", experience: "6 years", publications: 22, researchInterests: "Software Architecture, Cloud Computing, DevOps", awards: "" }
    ]
  },
  {
...
const noticesData = [
  { title: "Examination Schedule for Semester End 2026", category: "Examination", date: "25 Mar 2026", link: "#", description: "Examination timetable published. Check the official portal for details." },
  ...
  { title: "Summer Internship Program 2026", category: "Placement", date: "18 Mar 2026", link: "#", description: "Applications open for Summer Internship Program 2026." },
  { title: "Scholarship Applications Open - Apply by 30th April", category: "Scholarship", date: "15 Mar 2026", link: "#", description: "National Scholarship Portal applications are now open." },
  { title: "Convocation 2026 Date Announced - 15th April", category: "Event", date: "12 Mar 2026", link: "#", description: "8th Annual Convocation will be held on 15th April 2026." },
  { title: "Online Examination Guidelines Published", category: "Examination", date: "10 Mar 2026", link: "#", description: "Guidelines for online examinations have been published." },
  { title: "Library Holiday Schedule - April 2026", category: "General", date: "8 Mar 2026", link: "#", description: "Library will remain closed on public holidays during April." },
  { title: "Anti-Ragging Committee Meeting Notice", category: "General", date: "5 Mar 2026", link: "#", description: "Anti-ragging committee meeting scheduled for 10th March 2026." },
  { title: "Mid Semester Exam Results Published", category: "Examination", date: "1 Mar 2026", link: "#", description: "Mid semester examination results are now available." },
  { title: "New Course Registration for Next Semester", category: "Academic", date: "28 Feb 2026", link: "#", description: "Course registration for next semester starts from 1st March." },
  { title: "Annual Sports Meet 2026 Registration", category: "Event", date: "25 Feb 2026", link: "#", description: "Register for Annual Sports Meet 2026 by 28th February." },
  { title: "Research Grant Opportunities for Faculty", category: "Scholarship", date: "22 Feb 2026", link: "#", description: "Applications invited for research grants. Last date: 15th March." },
  { title: "Campus Placement Drive - TCS and Infosys", category: "Placement", date: "20 Feb 2026", link: "#", description: "TCS and Infosys recruitment drive on 25th February 2026." }
];
